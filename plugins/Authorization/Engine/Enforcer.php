...
use Plugins\Authorization\Engine\Exceptions\EmptyConditionException;
use Plugins\Authorization\Engine\Exceptions\ObjConditionException;
...
class Enforcer extends ManagementEnforcer
{
    ...
    private function removeDumplicatePermissions(array $permissions): array
    {
        ...
        foreach ($permissions as $permission) {
            $permissionStr = arrayToCommaSeparatedStr($permission);
