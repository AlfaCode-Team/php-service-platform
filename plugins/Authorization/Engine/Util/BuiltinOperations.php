...
namespace Plugins\Authorization\Engine\Util;
...
class BuiltinOperations
{
    ...
    {
        return isIpInCidrRange($ip1, $ip2);
    }
     ...
     * @return Closure
     */
    public static function generateGFunction(RoleManager|null $rm = null): Closure
    {
        $memorized = [];
     ...
     * @return Closure
     */
    public static function generateConditionalGFunction(ConditionalRoleManager|null $crm = null): Closure
    {
