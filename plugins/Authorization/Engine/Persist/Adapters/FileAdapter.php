...
namespace Plugins\Authorization\Engine\Persist\Adapters;
...
use Plugins\Authorization\Engine\Exceptions\NotImplementedException;
...
use Plugins\Authorization\Engine\Interfaces\Persist\UpdatableAdapter;
        ...
        if (isset($model['p'])) {
            foreach ($model['p'] as $ptype => $ast) {
                foreach ($ast->policy as $rule) {
                    $writeString .= $ptype . ', ';
                    $writeString .= arrayToCommaSeparatedStr($rule);
                    $writeString .= PHP_EOL;
                }
            }
        }
