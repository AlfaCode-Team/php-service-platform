...
/**
 * Tenancy — central `audit_log` (CONTROL PLANE), append-only.
 *
 * Attributable trail for security/compliance: login, tenant.switch,
 * tenant.create, member.invite, etc. Lives central so cross-tenant admin actions
 * are captured in one place. Stores identifiers + structured meta only — no
