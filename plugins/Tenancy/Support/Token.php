...
/**
 * Token — small dependency-free helpers for opaque secrets and ULIDs used by
 * the control-plane services (invitations, refresh tokens, audit ids).
 *
 * Secrets are stored ONLY as their SHA-256 hash; the raw value is shown once.
 */
final class Token
{
