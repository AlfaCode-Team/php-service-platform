 ...
 */
final class AuditLogRepository implements AuditReader
{
    ...
    public function find(string $eventId): ?AuditEntry
    {
        try {
            ...
            throw new RepositoryException('Failed to load audit entry.', layer: 'repository.tenancy', previous: $e);
        }
    ...
    public function countForTenant(string $tenantId): int
    {
        try {
            ...
            throw new RepositoryException('Failed to count audit entries.', layer: 'repository.tenancy', previous: $e);
        }
    ...
    public function purgeOlderThan(\DateTimeImmutable $cutoff): int
    {
        try {
            ...
            throw new RepositoryException('Failed to purge audit entries.', layer: 'repository.tenancy', previous: $e);
        }
    }
    ...
    private function page(string $where, array $params, int $limit, ?int $beforeId): array
    {
        ...
        try {
            ...
            throw new RepositoryException('Failed to list audit entries.', layer: 'repository.tenancy', previous: $e);
        }
