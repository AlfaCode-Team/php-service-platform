...
class SitemapBuilder implements SitemapBuilderInterface
{
	...
	public function __construct(string $domain, ?array $options = null, string $ns = '')
	{
		...
		$urlset = '<!-- Generated by https://hkmcode.io/phpshots_site_seo --><?xml-stylesheet type="text/xsl" href="'.$this->domain.'/sitemaps_xsl.xsl"?> <urlset xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd" xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"';
	...
	public function url(string $url): SitemapBuilderInterface
	{
		...
		$this->url['loc'] = Escape::escapeUrl($url);
		return $this;
	}
	...
	public function alternate(string $path, string $lang)
	{
		...
		$this->url['alternate'][] = [Escape::escapeUrl($this->domain . $path), $lang];
		return $this;
	}
