...
import { fireNavigateEvent } from './eventHandler/events'
...
export class InitialVisit {
  ...
  /**
   * Handles an external redirect (server responded with a 409 + location header),
   * completing the visit after the browser has navigated to the external URL.
   */
