...
export type PageflowEvent = 'missingHistoryItem' | 'loadDeferredProps'
...
export type PageflowAppResponse = Promise<{ head: string[]; body: string } | void>
...
declare global {
  interface DocumentEventMap {
    'pageflow:before': GlobalEvent<'before'>
    'pageflow:start': GlobalEvent<'start'>
    'pageflow:progress': GlobalEvent<'progress'>
    'pageflow:success': GlobalEvent<'success'>
    'pageflow:error': GlobalEvent<'error'>
    'pageflow:invalid': GlobalEvent<'invalid'>
    'pageflow:exception': GlobalEvent<'exception'>
    'pageflow:finish': GlobalEvent<'finish'>
    'pageflow:navigate': GlobalEvent<'navigate'>
  }
}
