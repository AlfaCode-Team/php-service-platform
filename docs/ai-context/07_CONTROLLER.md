# AlfacodeTeam PhpServicePlatform — HTTP Controller Layer Context
...
`Request` is a final, IMMUTABLE value object (Symfony HttpFoundation under the hood —
see "HTTP LAYER — USAGE" in CLAUDE.md for the full list). The methods controllers/DTOs
reach for:
