# AlfacodeTeam PhpServicePlatform — CSRF Protection (CsrfTokenLayer)
...
Wire it in `withSecurity([...])` (3rd layer, after firewall + rate limiter):
...
->withSecurity([
    ...
    new CsrfTokenLayer(                                                               // 3rd — stateless HMAC
